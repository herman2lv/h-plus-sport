...
/**
 * A service class of model layer, intended to process operations with {@code Order}.
 */
public class OrderService {
     ...
     * @return {@code true} if DAO object reports that entry containing order id was successfully
    ...
    /**
     * Get {@code List} of {@code Order} that represented in information storage. Get only items for
     ...
     *
     * @param orderId {@code int} value of unique {@code Order} id
     * @return {@code true} if order confirmation status was changed successfully.
     */
    ...
    /**
     * Changes {@code Order} confirmation status for {@code true} - "approved", or {@code false} -
     * "pending/rejected".
     *
     * @param orderId {@code int} value of unique {@code Order} id
     * @param status  {@code boolean} - new order confirmation status. {@code true} for "approved",
     *                and {@code false} for "pending/rejected"
     * @return {@code true} if order confirmation status was changed successfully.
     */
    ...
    /**
     * Changes {@code Order} confirmation status for {@code false} - "pending/rejected".
     *
     * @param orderId {@code int} value of unique {@code Order} id
     * @return {@code true} if order confirmation status was changed successfully.
     */
